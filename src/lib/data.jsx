...
export const lunchMenu = [
    ...
    items:[
        ...
        { name: "TOMATO & BURRATA", ingredients:"HERILOOM TOMATO, BURRATA, BASIL, CABERNET VINEGAR, OLIVE OIL"},
...
export const dinnerMenu = [
    {
        title: 'SMALL PLATES',
        items: [
            { name: "RED KURI SQUASH SOUP", ingredients:"SUMAC YOGURT, SNAPDRAGPON APPLES, PUMPKINS SEEDS, HERBS"},
