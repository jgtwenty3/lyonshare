...
const ArtistCard = ({ artist, date, img, bio, reverse, fullWidth }) => {
  ...
  return (
    <div className={`w-full p-4 flex flex-col ${reverse ? 'md:flex-row-reverse' : 'md:flex-row'} items-center ${fullWidth ? 'border-2 border-darkNavy ' : 'border border-darkNavy rounded-lg'}`}>
      ...
      <div className="p-4 w-full md:w-1/2">
        ...
        <p className="text-darkNavy text-3xl">{formattedDate}</p>
